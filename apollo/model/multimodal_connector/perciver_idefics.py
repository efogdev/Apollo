...
class Idefics2PerceiverAttention(nn.Module):
    def __init__(self, connector_config, layer_idx: Optional[int] = None) -> None:
        ...
        self.num_key_value_heads = connector_config.resampler_config.num_key_value_heads
        self.num_key_value_groups = self.num_heads // self.num_key_value_heads
        self.attention_dropout = connector_config.attention_dropout
...
class Idefics2PerceiverLayer(nn.Module):
    def __init__(self, connector_config, layer_idx: int):
        ...
        self.rms_norm_eps = connector_config.rms_norm_eps
        ...
        self.self_attn = IDEFICS2_PERCEIVER_ATTENTION_CLASSES[connector_config._attn_implementation](connector_config, layer_idx=layer_idx) ##TODO: not sure correct 
        ...
        self.mlp = Idefics2MLP(
            ...
            intermediate_size=connector_config.text_hidden_size * 4,
