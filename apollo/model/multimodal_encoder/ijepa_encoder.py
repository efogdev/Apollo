...
from .jepa.models.vision_transformer import vit_huge, vit_giant
from .vision_processors import ImageProcessor


class IJepaVisionTower(VisionTower):
    ...
    def load_model(self, device_map=None):
        ...
        self.image_processor = ImageProcessor(preprocess, height=self._image_size, width=self._image_size)
