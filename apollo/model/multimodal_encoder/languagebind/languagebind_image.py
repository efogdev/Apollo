...
class LanguageBindImageEncoderConfig(PretrainedConfig):
    r"""
...
class LanguageBindImageConfig(PretrainedConfig):
    ...
    def __init__(
        self, vision_config=None,  **kwargs
    ):
        ...
        if vision_config_dict is not None:
            ...
            _vision_config_dict = LanguageBindImageEncoderConfig(**vision_config_dict).to_dict()
        ...
        self.vision_config = LanguageBindImageEncoderConfig(**vision_config)

    @classmethod
    def from_text_vision_configs(cls, vision_config: LanguageBindImageEncoderConfig, **kwargs):
        r"""
...
class LanguageBindImageEncoder(PreTrainedModel):
    config_class = LanguageBindImageEncoderConfig
    def __init__(self, config: LanguageBindImageEncoderConfig):
    ...
    @replace_return_docstrings(output_type=BaseModelOutputWithPooling, config_class=LanguageBindImageEncoderConfig)
    def forward(
        self,
